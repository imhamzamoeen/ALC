@extends('admin.layouts.admin_master',['page' => 'users', 'action' => 'add'])
...
@endsection
@section('content')
    <form id="create-user-form" class="" role="form" method="post" action="{{ route(auth()->user()->user_type.'.users.save') }}">@csrf</form>
    @include('admin.users.form', ['action' => 'add'])
@endsection

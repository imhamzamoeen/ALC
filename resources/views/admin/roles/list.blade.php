            ...
            <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr class="odd">
                                ...
                                <td>
                                    <a href="{{ route(auth()->user()->user_type.'.'.$module_slug.'.assign', $row->id) }}"  class="badge badge-primary fs-7 m-1">
                                           <i class="fas fa-tag text-white"></i> Assign
                                    </a>
...
@push('after-script')
    <script>
        $('.delete-btn').on('click', function () {
            Swal.fire({
                text: 'Are you sure you want to delete "'+ $(this).data('name') +'" role?</br>',
                icon: 'warning',

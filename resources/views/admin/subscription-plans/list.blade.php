                            ...
                            <tr class="odd">
                                ...
                                <td class="d-flex align-items-center">
                                    <div class="d-flex flex-column">
                                        <a href="{{ route(auth()->user()->user_type.'.'.$module_slug.'.view', $row->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $row->title ?? '--' }}</a>
                                    </div>
                                </td>
                                <td>
                                    {{ $row->description }}
                                ...
                                <td>
                                   <strong style="font-size: 20px;">$ {{ $row->us_price }}</strong> / £ {{ $row->uk_price }}
                                </td>
                                <td>
                                   {{ beautify_slug($row->type) }}
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0);" data-name="{{ $row->title }}" data-id="{{ $row->id }}" class="menu-link px-3 delete-btn">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
@push('after-script')
    <script>
        $('.delete-btn').on('click', function () {
            Swal.fire({
                text: 'Are you sure you want to delete "'+ $(this).data('name') +'" subscription?</br>',
                icon: 'warning',

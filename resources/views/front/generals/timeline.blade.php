<div class="row student_timeline">
                        ...
                        @forelse($todayClasses as $class)
                            <div class="class px-3 py-2 @if ($class->live_status == 1) live @endif">
                                ...
                                <div class="d-flex align-items-center py-3">
                                    {!! generate_profile_picture_by_name($class->student->teacher->name, 24, 12) !!}
                                    <p class="ms-2 px-14 text-sb mb-0">{{ $class->student->teacher->name }}</p>
                                </div>
                                <hr class="my-0">
                ...
                <div class="tab-pane fade mb-3" id="upcomings" role="tabpanel" aria-labelledby="upcomings-tab">
                    @isset($nextClasses)
                        ...
                        <a class="nav nav-item nav-link btn color-primary float-end text-sb" href="javascript:void(0)"
                            id="view-classes" data-bs-toggle="tab" data-component="class_schedule"
    ...
    <div class="col-md-8 col-12 border rounded student-notifications">
                            ...
                            <div class="live py-2">
                                <div class="mx-3 pe-0 pe-md-2 ps-1">
                                    <div>
                                        <span>
                                            <p class="mb-0">
                                                {{ ucfirst($class['student']['course']['title']) . '`s ' . ' class with Teacher ' . ucfirst($class['student']['teacher']['name']) . ' has just begun. here is the live class link:' }}
                                            </p>
    ...
    {{-- TIMELINE CSS --}}
    <style>
        .student_timeline .live {
            background-color: var(--secondary-color);
            border-left: 3px solid var(--primary-color);
            margin-top: 10px;
        }

        .student_timeline .class:not(:first-child) {
            margin-top: 30px;
        }
        ...
        .student_timeline #view-classes {
            font-size: var(--px-14);
        }

        .student_timeline .time-heading {
            color: #ABB0BC;
            font-weight: 300;
        }

        .student_timeline #view-classes:focus {
            box-shadow: none;
        }

    ...
    (function($, window, document, undefined) {
        ...
        $.extend(Plugin.prototype, {
            init: function() {
                ...
                var header = $('<header>' +
                    '<h2 class="month"></h2>' +
                    '<a class="notification-calendar-btn btn-prev" href="#"></a>' +
                    '<a class="notification-calendar-btn btn-next" style="display:none" href="#"></a>' +
                    '</header>');
            ...
            buildCalendar: function(fromDate, calendar) {
                ...
                for (var day = firstDay; day <= lastDay; day.setDate(day.getDate())) {
                    ...
                    for (var i = 0; i < 7; i++) {
                        ...
                        var lowerLimit = new Date(upperLimit.getFullYear(), upperLimit.getMonth() - 1,

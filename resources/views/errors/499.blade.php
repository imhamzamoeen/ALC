...
<body>
    <div class="d-flex align-items-center justify-content-center error-wrapper container">
        <div class="text-center">
            ...
            <h4 class="mb-4 fw-bold" style="font-size: 26px">{{ isset($exception) ? $exception->getMessage() : (isset($message) ? $message : 'Action Not supported') }}</h4>
            <h5 class="mb-4" style="font-size: 16px">{{ "waqt p aao" }}</h5>

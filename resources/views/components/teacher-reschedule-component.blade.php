    ...
    <div class="container">
            ...
            <div class="col-sm-12 col-12">
                ...
                @isset($Model)
                    ...
                    <form class="" role="form" method="post"
                        action="{{ route('teacher.MakeRescheduleRequest', [app()->getLocale()]) }}"
                    ...
                    <div class="timetable-wrapper w-100">
                        ...
                        <div class="row text-center m-0 timetable-slots w-100">
                            @if (isset($TotalSlots) && $TotalSlots->isNotEmpty())
                                @foreach (get_current_week() as $key => $day)
                                    <div class="col p-0">
                                        {{-- <h5 class="text-med px-14 mb-4">Mon</h5> --}}
                                        <div class="ms-2 ms-sm-0 slots-col" style="height: 100%">
                                            @if ($TotalSlots->has([$key]))
                                                @foreach ($TotalSlots[$key] as $k => $slot)
                                                    @if (in_array($slot, $BookedSlots[$key]))
        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-12 mt-sm-4 mt-3 text-sm-end text-center">
                <button type="submit" form="slots-selection-form" class="btn btn-primary px-5 py-3">
                    Submit
                </button>
            </div>
        </div>

                                ...
                                <div class="col-lg-7 col-sm-8 col-12">
                                    <div class="subscription-tabs" id="timetable-tab">
                                        <h4 class="px-18 text-bold pb-1">
                                            {{ __('Change Schedule for ' . $student->name) }}!
                                        </h4>
                                        {{-- {{dd($student)}} --}}
                                        {{-- <h4 class="px-18 text-bold pb-1">{{ __('Change Schedule for Haroon Mukhtar')
                                        }}!
                                    </h4> --}}
                                        <p class="px-14 text-med mb-1 mb-sm-4">Below are the available days and time slots
                                            for
                                        ...
                                        <p class="px-14 text-med d-block d-sm-none text-danger mt-1 pb-3">
                                    ...
                                    <div class="subscription-tabs" id="payment-tab" style="display: none">

                                        @include('front.customer.components.payment_module')
                                    </div>
                                    <div class='alert-danger px-14 px-2 py-2 alert error alert-dismissible form-group mt-3'
                                        style="display: none">Please
                                        correct the errors
                                        and try
                                        again. <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="alert  alert-info mb-0 mb-sm-2 mt-3 px-14 px-2 py-2" role="alert">
                                        *Please note that we charge $45 for changing Schedule.
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-5 col-sm-4 col-12 mt-5 mt-sm-0">
                                    ...
                                    <div class="package_summary">
                                        <div class="container-lg p-3 px-14 text-med">
                                            ...
                                            <div class="row text-danger py-2">
                                                <div class="col-6">{{ __('Schedule Change Charges') }}</div>
                                                <div class="col-6 text-bold text-end">
                                                    $45</div>
                                            </div>
                                            <hr class="my-2">
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <div class="col-6 text-bold text-end">$<span
                                                        class="calculated-slots-price">0</span></div>
                                            </div>
                ...
                <a class="btn btn-outline-primary px-5 py-2 d-none" id="back-btn-two">Back</a> --}}
                    ...
                    <ul class="nav subscription_nav justify-content-end align-items-end align-items-sm-center flex-sm-row flex-column-reverse"
                        ...
                        <button class="btn btn-primary px-sm-3 py-2 nav-btn" disabled id="next"
                            data-target="payment-tab" data-current="timetable-tab">Next</button>
                        <button class="btn btn-primary px-sm-3 py-2 nav-btn" type="submit" data-current="payment-tab"
                            data-target="none" id="confirm-schedule-btn" style="display: none">Pay

...
KTUtil.ready(function () {
    ...
    // Init Code Highlighter & Preview Blocks(used to trialnstrate the theme features)
    KTLayoutExamples.init();

    // Init Trial Selection Panel
    KTLayoutTrialPanel.init("kt_trial_panel");
...
var KTLayoutTrialPanel = (function () {
    // Private properties
    var _element;
    ...
    var _init = function () {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: "offcanvas",
            placement: "right",
            closeBy: "kt_trial_panel_close",
            toggleBy: "kt_trial_panel_toggle",
        });
        ...
        if (typeof offcanvas !== "undefined" && offcanvas.length === 0) {
            offcanvas.on("hide", function () {
                ...
                KTCookie.setCookie("kt_trial_panel_shown", 1, {
                    expires: expires,
                });
            });
        }
    ...
    var _remind = function () {
        ...
        setTimeout(function () {
            if (!KTCookie.getCookie("kt_trial_panel_shown")) {
...
// Webpack support
if (typeof module !== "undefined") {
    module.exports = KTLayoutTrialPanel;
}
